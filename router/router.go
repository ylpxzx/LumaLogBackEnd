...
func New(h *handler.Handler) *gin.Engine {
	...
	protected.PATCH("/items/:id/archive", h.ArchiveItem)
	protected.PATCH("/items/:id/unarchive", h.UnarchiveItem)
	protected.GET("/items/:id/stats", h.ItemStats)
	protected.GET("/items/:id/badges", h.ItemBadges)
	protected.GET("/items/:id/share", h.ItemShare)
